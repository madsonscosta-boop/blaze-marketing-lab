      ...
      {open && (
        <div className="fixed inset-0 z-40 bg-foreground/95 backdrop-blur-xl animate-fade-in">
          <nav className="flex h-full w-full flex-col items-center justify-center gap-6 text-background animate-scale-in">
            <Link to="/" hash="servicos" className="font-display text-5xl md:text-7xl tracking-tight transition hover:text-brand-glow" activeProps={{ className: "text-brand-glow" }} onClick={() => setOpen(false)}>Serviços</Link>
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            <li><Link to="/" hash="servicos" className="hover:text-brand-glow">Serviços</Link></li>
